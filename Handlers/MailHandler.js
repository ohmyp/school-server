...
class mailHandler {
    makeLetter(data) {
        ...
        let resultsP = ''
        Object.entries(data.results).forEach(p => {
            resultsP += `<p>${p[0]}: ${p[1]}</p>\n`
            })
                    ...
                    <td class="container">
                        <table>
                            ...
                            <tr>
                                <td class="content">
                                    <p>${date}</p>
                                    <h2>${data.user.firstName} ${data.user.lastName}, ${data.user.classNumber}${data.user.classLetter}</h2>
                                    ${resultsP}
                                    <strong>Максимум: ${data.max}</strong>
                                </td>
                            </tr>
                        </table>
                    </td>
                        ...
                        <table>
                            <tr>
                                <td class="content footer">
                                    <p>Отправлено <a href="https://oneschool511.ru">Единая школа 511</a></p>
                                </td>
                            </tr>
                        </table>
                    </td>
